...
* **Requirements** https://www.youtube.com/watch?v=eW0BmZ8i8Eo (Remember to use "pip3 install -r requirements.txt" inside the project folder and how to run the app (https://www.youtube.com/watch?v=bzX_auqvePs))
